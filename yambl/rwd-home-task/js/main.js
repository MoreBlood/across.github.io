...
$('.title').html(getPartOfTheText(text, 0, 5));
...
$('.image-wrapper').on('click', function () {
    ...
    $('.show-off').css({'background-image': 'url(' + url + ')', 'display': 'block'});
    $('.gallery, .title-wrapper, .footer').css({'filter': 'blur(10px)'});
});

$('.show-off').on('click', function () {
    $('.show-off').css({'display': 'none'});
    $('.gallery, .title-wrapper, .footer').css({'filter': ''});
});
